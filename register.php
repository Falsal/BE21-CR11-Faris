...
//linkup with external files
require_once 'components/db_connect.php';
require_once 'components/file_upload.php';
//initialize variables to collect input values in them
$error = false;
$fname = $lname = $email = $date_of_birth = $pass = $picture = '';
$fnameError = $lnameError = $emailError = $dateError = $passError = $picError = '';
//when form is submitted 
// 1) assign input values to pre-defined variables
// 2) before assignment , clean up collected input values:
//    trim,strip, strip_tags and htmlspacialcharachters
...
<html lang="en">
    ...
    <body>
        <div class="container">
            <form class="w-75" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"  autocomplete="on" enctype="multipart/form-data">
                <h2>Sign Up.</h2>
                <hr/>
                <?php
                if (isset($errMSG)) {
